...
public class TimingLogger {
     ...
     * least the Level.FINE level for that tag at creation time then
     ...
     * Log.isLoggable is not enabled to at least the Level.FINE
     ...
     * Log.isLoggable was not enabled to at least the Level.FINE for
     ...
     * not enabled to at least the Level.FINE for the specified tag at
