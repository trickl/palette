...
public final class Palette {
    ...
    /**
     * Listener to be used with {@link #generateAsync(BufferedImage, PaletteAsyncListener)} or
     * {@link #generateAsync(BufferedImage, int, PaletteAsyncListener)}
     */
    ...
    public static final class Swatch {
        ...
        public String toString() {
            return new StringBuilder(getClass().getSimpleName())
                    ...
                    .append(" [Title Text: #").append(Integer.toHexString(getTitleTextColor().getRGB()))
                    .append(']')
                    .append(" [Body Text: #").append(Integer.toHexString(getBodyTextColor().getRGB()))
                    .append(']').toString();
        }
    ...
    public static final class Builder {
         ...
         * {@link android.graphics.BufferedImage} as the source.
         * <p>
        ...
        /**
         * Set the resize value when using a {@link android.graphics.BufferedImage} as the source.
         ...
         *
         * @param area the number of pixels that the intermediary scaled down BufferedImage should cover,
         *             or any value <= 0 to disable resizing.
         */
        @NonNull
         ...
         * <p>This only works when the original input is a {@link BufferedImage}.</p>
         *
            ...
            if (mBufferedImage != null) {
                ...
                if (!mRegion.intersects(left, top, right - left, bottom - top)) {
                    throw new IllegalArgumentException("The given region must intersect with "
                            + "the BufferedImage's dimensions.");
                }
            }
            return this;
        }
        ...
        private int[] getPixelsFromBufferedImage(BufferedImage bitmap) {
            ...
            final int[] data = bitmap.getRaster()
                    .getPixels(0, 0, bitmapWidth, bitmapHeight, (int[]) null);
            ...
            if (mRegion == null) {
                ...
                for (int row = 0; row < regionHeight; row++) {
                    System.arraycopy(pixels, ((row + mRegion.y) * bitmapWidth) + mRegion.x,
