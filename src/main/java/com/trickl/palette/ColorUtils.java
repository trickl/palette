...
public final class ColorUtils {
    ...
    public static Color compositeColors(Color foreground, Color background) {
        ...
        int r = compositeComponent(foreground.getRed(), fgAlpha,
                background.getRed(), bgAlpha, a);
        int g = compositeComponent(foreground.getGreen(), fgAlpha,
                background.getGreen(), bgAlpha, a);
        int b = compositeComponent(foreground.getBlue(), fgAlpha,
                background.getBlue(), bgAlpha, a);
     ...
     */
    public static int calculateMinimumAlpha(Color foreground, Color background,
     ...
     */
    public static Color setAlphaComponent(Color color,
     ...
     * @param outLab 3-element array which holds the resulting Lab components
     */
    public static void XYZToLAB(@FloatRange(from = 0f, to = (float) XYZ_WHITE_REFERENCE_X) double x,
     ...
     */
    public static Color XYZToColor(@FloatRange(from = 0f, to = (float) XYZ_WHITE_REFERENCE_X) double x,
            @FloatRange(from = 0f, to = (float) XYZ_WHITE_REFERENCE_Y) double y,
            @FloatRange(from = 0f, to = (float) XYZ_WHITE_REFERENCE_Z) double z) {
        ...
        return new Color(constrain((int) Math.round(r * 255), 0, 255), constrain((int) Math.round(g * 255), 0, 255), constrain((int) Math.round(b * 255), 0, 255));
    }
     ...
     * @return int containing the RGB representation
     */
    public static Color LABToColor(@FloatRange(from = 0f, to = 100) final double l,
            @FloatRange(from = -128, to = 127) final double a,
            @FloatRange(from = -128, to = 127) final double b) {
        final double[] result = getTempDouble3Array();
     ...
     */
    public static Color blendARGB(Color color1, Color color2,
    ...
    public static void blendHSL(@NonNull float[] hsl1, @NonNull float[] hsl2,
            @FloatRange(from = 0.0f, to = 1.0f) float ratio, @NonNull float[] outResult) {
    ...
    public static void blendLAB(@NonNull double[] lab1, @NonNull double[] lab2,
            @FloatRange(from = 0.0f, to = 1.0f) double ratio, @NonNull double[] outResult) {
        if (outResult.length != 3) {
